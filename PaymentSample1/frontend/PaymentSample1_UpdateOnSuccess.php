<?php
/* 
  In this override you can change the status on success. But if you already made a transaction and placed that on the success status no action is required here.
  ...
  return    nothing or default (when not implemted) action is based on the status of the transaction
            "PaymentImplementationStatus_Unknown"       default return see above. if an transaction is found, it is placed in the success state.
